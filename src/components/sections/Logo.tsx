...
export const Logo = () => {
  return (
    <div className="flex items-center gap-2">
      ...
      <span className="font-normal text-[18px]">Lumi</span>
    </div>
  );
};
